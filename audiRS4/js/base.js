...
$('.form .btn .r').on('click', function () {
    ...
    tijiao = 1;
    var chexing = $('.form-div').eq(0).val();
    var name = $('.form-div').eq(1).val();
    var mobile = $('.form-div').eq(2).val();
    var pro_id = $('.select').eq(0).find('option:selected').attr('pro_id');
    var city_id = $('.select').eq(1).find('option:selected').attr('city_id');
    var jxs_id = $('.select').eq(2).find('option:selected').attr('jxs_id');
