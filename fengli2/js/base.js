...
function getPrizeNumber() {
                ...
                success:function(json){
                    ...
                    function fn() {
                        if( remain <=0 ){
                            ...
                            $(".dialog").show();
                            $(".dialog .money-span").html(xiabiao!="0"?xiabiao+"元":"谢谢参与");
    ...
    function getXiabiao(num) {
        ...
        if(num=="0"){//谢谢参与
            ...
            random=new Array(0,1,3,4,5,7);//金额随机
        }
    ...
    $(".fixed-div").on("click",'.ch',function(){
        if(!$(this).children(".con").hasClass("active")){
            $(this).children(".con").addClass("active");
            $(this).siblings().children(".con").removeClass("active");
            $(this).find(".img1").css("opacity","0");
            $(this).siblings().find(".img1").css("opacity","1");
            $(this).find(".bottom").css("color","#FF5674");
            $(this).siblings().find(".bottom").css("color","rgb( 87, 87, 87 )");
        }
    });
});
