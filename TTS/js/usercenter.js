$(function () {
              ...
              if($('.right-content').find('.wrap').eq(i).attr("type")==index){
                  ...
                  if(index==0){//发布内容
                    $(".fabu .content-display").each(function () {
                        ...
                        $(this).find(".url-input").attr('isUpload','0');
                        $(this).find('.pickfileProcess').find(".line").css("width",0);
    ...
    $(".fabu").on("click",'.content-display.active .submit img',function () {
        ...
        var isUpload=$(".content-display.active").find(".url-input").attr('isUpload');
...
function GetForumDetailForEdit(id,index) {
    $.request('/api/Forum/GetForumDetailForEdit', {
        ...
        function (res) {
            ...
            $(".content-display.active").find(".url-input").attr('isUpload','1');
        }
    );
}
            ...
            function (res) {
                ...
                if(res.data.list!=""){
                    ...
                    res.data.list.forEach((ele, k) => {
                        ...
                        str+='<div class="box"><span class="desc">'+ele.content+'</span><span class="time">'+ele.createTime+'</span></div>';
...
function resetPublish(){
    ...
    $(".content-display").find(".url-input").attr('isUpload','0');
    ue1.ready(function() {
        ue1.setHeight(200);
        //设置编辑器的内容
