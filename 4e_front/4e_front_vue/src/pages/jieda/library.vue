<template>
	<div class="jieda-library">
		...
		<div class="tab">
			...
			<div class="submenu">
				<ul>
					<li v-for="(item,index) in submenu" :class="item.active==1?'active':''" :data-id="item.id" @click="changeSubMenu(item.id, item.permissionCode)">
		...
		<div class="frame_main">
			<iframe :src="main_url" style="width:100%;" scrolling="no" frameborder="0"></iframe>
		</div>
	</div>
</template>
...
export default {
	...
	methods: {
		...
		changeSubMenu: function(id, code) {
