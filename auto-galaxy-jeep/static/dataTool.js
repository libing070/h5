/**
 * Created by huangyuanjie1 on 2017/8/22.
 */
!function (e, t) {
    ...
    return function (e) {
        ...
        o = function (e) {
            var t = r(1);
            return t.dataTool = {version: "1.0.0", gexf: r(5), prepareBoxplotData: r(6)}, t.dataTool
        ...
        o = function (e) {
            ...
            function t(e) {
                ...
                return {nodes: n(l(u, "nodes"), c), links: a(l(u, "edges"))}
            }
            ...
            function n(e, t) {
                return e ? s.map(u(e, "node"), function (e) {
                    var r = i(e, "id"), o = i(e, "label"), n = {id: r, name: o, itemStyle: {normal: {}}},
                        a = l(e, "viz:size"), s = l(e, "viz:position"), c = l(e, "viz:color"), f = l(e, "attvalues");
                    if (a && (n.symbolSize = parseFloat(i(a, "value"))), s && (n.x = parseFloat(i(s, "x")), n.y = parseFloat(i(s, "y"))), c && (n.itemStyle.normal.color = "rgb(" + [0 | i(c, "r"), 0 | i(c, "g"), 0 | i(c, "b")].join(",") + ")"), f) {
                        ...
                        for (var v = 0; v < p.length; v++) {
                            var d = p[v], g = i(d, "for"), h = i(d, "value"), b = t[g];
                            if (b) {
                                switch (b.type) {
                                    case"integer":
                                    case"long":
            ...
            function a(e) {
                return e ? s.map(u(e, "edge"), function (e) {
                    //huangyuanjie
                    var weight = i(e, "weight");
                    if (weight == null) { //边权重为1的时候不显示权重
                        weight = "1.0";
                    }
                    var t = i(e, "id"), r = i(e, "label"), o = i(e, "source"), n = i(e, "target"),
                        //huangyuanjie
                        a = {
                            id: t,
                            name: r,
                        ...
                        // a = {id: t, name: r, source: o, target: n, lineStyle: {normal: {}}}, u = a.lineStyle.normal,
                        s = l(e, "viz:thickness"), c = l(e, "viz:color");
        ...
        var o;
        o = function (e) {
            var t = r(7), o = r(1).number;
            return function (e, r) {
                r = r || [];
                for (var n = [], a = [], i = [], l = r.boundIQR, u = 0; u < e.length; u++) {
                    i.push(u + "");
                    var s = o.asc(e[u].slice()), c = t(s, .25), f = t(s, .5), p = t(s, .75), v = p - c,
                ...
                return {boxData: n, outliers: a, axisData: i}
            }
        }.call(t, r, t, e), !(void 0 !== o && (e.exports = o))
    }, function (e, t, r) {
        var o;
        o = function (e) {
            return function (e, t) {
                var r = (e.length - 1) * t + 1, o = Math.floor(r), n = +e[o - 1], a = r - o;
