...
class Ddmp {
    ...
    function send($data)
    {
        ...
        if ($car==4) {
            ...
            $senddata['ModelId'] = "C89CC739-3D9F-499C-999A-36D0C54AB9B5";
        }elseif ($car==5) {
            $senddata['SeriesId'] = "B29ABF09-5661-4211-892E-77A21F7F3AAA";
            $senddata['ModelId'] = "CDE2CB70-A7C5-4DF3-AAC7-CBD6E5282AB3";
        }
