...
$sql = "select count(1) as count from dyk_k3_user " . $cond . " order by uid desc";
...
$sql = "select * from dyk_k3_user " . $cond . " order by uid asc";
...
<div class="container-fluid main" style="margin-top: 50px;">
    <div class="col-md-2 ">
        ...
        <a href="./listForLitter.php" class="list-group-item active">回收站</a>
                            ...
                            <tr>
                                ...
                                <td>
                                    <button tag="<?php echo $e['uid']; ?>" type="button"
                                            class="btn btn-info btn-xs btn-tonguo">通过
                                    </button>
                                    <button tag="<?php echo $e['uid']; ?>" type="button"
...
<script>
    $(function () {
        $('.btn-tonguo').on('click', function () {
            var uid = $(this).attr('tag');
            myConfirm("确定要通过吗?", function () {
                $.localAjax('update.php',{uid:uid,status:1},function(res){
                    alert('保存成功',function(){
                        history.go(0);
                    });
                })
