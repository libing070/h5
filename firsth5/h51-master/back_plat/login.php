...
<div class="container">
    <div class="login_tag">
        <h2 class="login_header"> 管理后台 </h2>
        <form class="form_signin" id="filter" action="check.php" method="post">
...
<script type="text/javascript" src="<?php echo $static_url?>/js/jquery-1.10.2.min.js"></script>
<script type="text/javascript" src="<?php echo $static_url?>/js/bootstrap.min.js"></script>
<script type="text/javascript" src="<?php echo $static_url?>/js/common_fun.js"></script>
